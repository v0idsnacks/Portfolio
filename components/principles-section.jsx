  ...
  const principles = [
    {
      ...
      description: "Building interactive interfaces with hooks, state management, and component architecture.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        ...
        { text: " MASTERY", highlight: false },
      ],
      description: "Full-stack development with SSR, API routes, and optimized performance patterns.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        { text: "PIXEL ", highlight: false },
        { text: "PERFECT", highlight: true },
      ],
      description: "Crafting responsive, accessible designs with Tailwind CSS and component libraries.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "GSAP ", highlight: false },
        { text: "ANIMATIONS", highlight: true },
      ],
      description: "Smooth, performant animations and interactive experiences that delight users.",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">TECHNICAL TOOLKIT</h2>
      </div>
